...
public class HistoryFood {
    ...
    @FXML
    private TableView<HistoryFoodEntity> mainTable;
    @FXML
    private TableColumn<HistoryFoodEntity, Integer> idCol;
    @FXML
    private TableColumn<HistoryFoodEntity, Date> dateCol;
    @FXML
    private TableColumn<HistoryFoodEntity, String> userCol;
    @FXML
    private TableColumn<HistoryFoodEntity, Integer> countCol;
    @FXML
    private TableColumn<HistoryFoodEntity, String> descCol;
    @FXML
    ...
    @FXML
    void initialize() {
        idCol.setCellValueFactory(new PropertyValueFactory<>("idhistoryFood"));
